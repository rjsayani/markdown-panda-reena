...
This dataset has `r nrow(usgs)` samplings sites.
...
###Subheding for sectio 2.1
#Data and Metadata Standards

1. Microsoft Access Database format will be used since it is
...
1. Every effort will be made to go back to the authoritative source for an
...
1. A data dictionary will be created that defines the table definition,
...
1.The data are public and will be obtainable thru the New Mexico
...
1. Access to databases and associated software tools generated under the
...
2.Materials generated under the project will be disseminated in accordance
